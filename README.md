...
Ix2y, Iy2x, Ixy = granger_causality(S, H, SIG)
...
```python
from pygc import wilson_factorization_jax, JAX_AVAILABLE

if JAX_AVAILABLE:
    Snew, H, SIG = wilson_factorization_jax(S, f, Fs)
```
